...
namespace Simplify
{
	...
	void simplifyMesh(lim::Mesh* mesh, float lived_pct, int agressiveness=7) {
		...
		simplify_mesh(target_count, 7.0, true);
	...
	void simplifyModel(lim::Model* model, float lived_pct = 0.8f) {
