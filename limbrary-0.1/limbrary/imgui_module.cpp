...
namespace lim
{
	void ImguiModule::initImGui(GLFWwindow* window)
	{
		IMGUI_CHECKVERSION();
		ImGui::CreateContext();
	...
	void ImguiModule::endImGui(float frameWidth, float frameHeight)
	{
